                    ...
                    RowLayout
                    {
                        ...
                        Item {
                            ...
                            ListView {
                                ...
                                {
                                    if (model.tempMove(-1, -1, true, false))
                                    {
//                                        syncManager.addMove(0, viewContext.id, -1, fromPos + moveFinal, 0, piece.isWhite, pieceModel.checkTook())
                ...
                Item {
                    ...
                    ListView {
                        id: moveList
                        width: model.moves.length > 0 ? model.moves.length * 44 : model.displayDice.length * 44
                        height: parent.height
                        anchors.centerIn: parent
                        model: model.moves.length > 0 ? model.moves : model.displayDice
                        interactive: false
