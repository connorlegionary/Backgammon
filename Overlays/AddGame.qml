        ...
        ColumnLayout
        {
            ...
            Rectangle
            {
                ...
                MouseArea
                {
                    ...
                    onClicked:
                    {
                        var gameId = viewContext.database.createGame(computerPicker.currentIndex, scorePicker.model[scorePicker.currentIndex], timePicker.model[timePicker.currentIndex]/1000)
