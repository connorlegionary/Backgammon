#ifndef COMPUTERGAMESDATABASE_H
#define COMPUTERGAMESDATABASE_H

#include "database.h"

#include <QObject>

class ComputerGamesDatabase : public Database
{
    Q_OBJECT
...
public:
    explicit ComputerGamesDatabase(QObject *parent = nullptr);
    ...
    Q_INVOKABLE int finishGame(int gameId);
    ...
    Q_INVOKABLE int createGame(int computer, int score, int seconds);
    Q_INVOKABLE void saveGame(int id, QString data);
